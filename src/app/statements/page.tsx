...
export default function StatementsPage() {
  ...
  return (
    <AccountChrome>
      <div className="rounded-3xl border border-white/[0.07] bg-white/[0.028] p-6">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-end">
          <label className="flex-1 text-[12px] text-[#7a859c]">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-white/[0.08] bg-[#0b0d13] px-3 py-2 font-mono text-[13px] text-[#eaf0f8]"
            />
          </label>
          ...
          <button
            ...
            onClick={() => void load()}
            disabled={loading}
            className="h-11 rounded-2xl border border-[#2dd4bf]/40 bg-[#2dd4bf]/10 px-4 text-sm font-semibold text-[#9ae9da] disabled:opacity-50"
          >
        ...
        {error && (
          <p className="mt-4 text-sm text-[#f0a8a8]">{error}</p>
        )}
          ...
          <div className="mt-6 space-y-3">
            ...
            {(payload.disclosed || []).map((item) => (
              <a
                ...
                className="block rounded-2xl border border-white/[0.06] bg-[#0b0d13]/80 p-4 font-mono text-[13px] text-[#d8deea]"
              >
