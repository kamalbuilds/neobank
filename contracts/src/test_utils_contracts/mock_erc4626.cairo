//! Test ERC-4626 vault: 1:1 shares for an underlying mock ERC20.
//! Same deposit/redeem/asset surface as a Vesu vToken so the card program helper
//! can be pointed at Vesu on mainnet without a signature change.

use starknet::ContractAddress;

#[starknet::interface]
pub trait IMockERC4626<T> {
...
pub mod MockERC4626 {
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn _burn(ref self: ContractState, owner: ContractAddress, amount: u256) {
            ...
            assert(balance >= amount, 'ERC4626: insufficient shares');
        ...
        fn _spend_allowance(
            ...
            assert(allowed >= amount, 'ERC4626: insufficient allowance');
            self.allowances.write(key, allowed - amount);
        }
    }

    #[abi(embed_v0)]
    pub impl MockERC4626Impl of super::IMockERC4626<ContractState> {
        fn asset(self: @ContractState) -> ContractAddress {
            self.asset.read()
        }

        fn deposit(ref self: ContractState, assets: u256, receiver: ContractAddress) -> u256 {
            assert(assets.is_non_zero(), 'ERC4626: zero assets');
            ...
            assert(pulled, 'ERC4626: pull failed');
